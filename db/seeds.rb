...
growth_hacking = Product.create(title: "Growth Hacking",
  subtitle: "Crash Course", author: "Mattan Griffel", author_image_name: "teacher-image.jpg", price: "4.99", download_url: "https://s3.amazonaws.com/scramjet-stripe/YIDS_Boo.jpg",
  sku: "GROHACK1", details: "You'll get one video", length: "30 minutes", description: %{  <p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
